...
1. Navigate to GitHub Models playground and select **o4-mini** as our model.

3. Under parameters, update the System Prompt with the following System Message:
...
Congratulations! You have now completed the second part of the lab, and have interacted with reasoning models. In the next part of the lab, you will learn how to use the model to generate image assets 

Move to [Reasoning](/docs/05_Reasoning.md) to proceed to the Reasoning section.